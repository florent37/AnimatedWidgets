...
class _ShakeAnimatedWidgetState extends State<ShakeAnimatedWidget> with TickerProviderStateMixin {
  ...
  void _createAnimations(){
    ...
    _animationController = AnimationController(duration: widget.shakeDuration , vsync: this)
